        ...
        <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-8">
          <div className="space-y-4 max-w-xl text-center lg:text-left">
           ...
           <div className="relative z-10 w-full sm:w-80 h-48 flex items-center justify-center flex-shrink-0">
             <img src={user?.avatar_url || '/images/hero_illustration.webp'} alt={`${user?.full_name || 'Teacher'} avatar`} className="w-36 h-36 rounded-[2rem] object-contain drop-shadow-md" />
          </div>
