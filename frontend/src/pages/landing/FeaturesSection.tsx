...
const features = [
  {
    ...
    badge: 'Core Feature',
    image: '/images/features_ai_planning.webp',
  },
  {
    icon: CheckSquare,
    ...
    badge: 'Automation',
    image: '/images/attendance_tracking.webp',
  },
  {
    icon: BarChart3,
    ...
    badge: 'Insights',
    image: '/images/analytics_dashboard.webp',
  },
  {
    icon: FileText,
    ...
    badge: 'Studio',
    image: '/images/document_studio.webp',
  },
  {
    icon: BrainCircuit,
    ...
    badge: 'RAG Powered',
    image: '/images/workflow_diagram.webp',
  },
];
