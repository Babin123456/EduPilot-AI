        ...
        <div className="flex items-center gap-3 relative z-10">
          <div className="relative">
            ...
            <input
              ...
              className="pl-10 pr-4 py-2 bg-slate-950/80 hover:bg-slate-950/90 border border-slate-700/80 rounded-xl text-xs text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-[#8CC63F] w-64 transition-all shadow-inner"
            />
          </div>
          <button
            onClick={handleDownloadReport}
            className="px-4 py-2 bg-slate-950 hover:bg-slate-900 text-white text-xs font-black rounded-xl flex items-center gap-2 transition-all shadow-lg active:scale-95 border border-slate-700"
          >
            <Download className="w-4 h-4 text-[#8CC63F]" />
            <span>PDF Roster Report</span>
          </button>
        </div>
